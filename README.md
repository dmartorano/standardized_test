...
|should_scores_be_submitted|bool|satactbycollegewithlocation|This boolean determines whether an average Maine student should submit test scores to an institution|
